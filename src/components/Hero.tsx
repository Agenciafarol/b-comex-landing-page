...
const Hero = () => {
  ...
  return <section className="pt-32 pb-20 bg-gradient-to-br from-white via-blue-50/30 to-orange-50/20 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-10 animate-pulse-grow" style={{
      animationDelay: '1s'
    }}>
      ...
      <div className="absolute bottom-1/4 left-1/4 animate-pulse-grow" style={{
      animationDelay: '2s'
    }}>
        <div className="w-12 h-12 bg-2b-blue/10 rounded-lg flex items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
              {t('hero.subtitle')}
            </p>
            ...
            {/* Features highlights */}
            <div className="flex flex-wrap gap-6 mb-8 justify-center lg:justify-start animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
            ...
            <Button onClick={handleCTAClick} className="bg-2b-orange hover:bg-orange-600 text-white font-semibold px-8 py-4 text-lg rounded-lg hover-scale animate-fade-in group" style={{
            animationDelay: '0.4s'
          }}>
              {t('hero.cta')}
