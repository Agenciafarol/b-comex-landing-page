...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-20 bg-2b-blue relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        <div className="flex justify-center mt-12">
          <div className="flex space-x-2">
            <div className="w-2 h-2 bg-2b-orange rounded-full animate-pulse"></div>
            <div className="w-2 h-2 bg-white/50 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
            <div className="w-2 h-2 bg-2b-orange rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
          </div>
        </div>
      </div>
    </section>
