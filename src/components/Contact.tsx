...
const Contact = () => {
  return <section id="contact" className="py-24 bg-white textured-bg">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20 scroll-animate">
          <h2 className="text-4xl md:text-5xl font-montserrat font-bold text-slate-900 mb-6">
            Vamos conversar?
          </h2>
          <p className="text-xl text-slate-700 font-opensans">Preencha o formulário ao lado ou fale conosco por WhatsApp. Nossa equipe responderá o mais rápido possível.</p>
          ...
          <Card className="scroll-animate shadow-2xl border-0">
            <CardContent className="p-10">
              <form className="space-y-8">
                <div>
                  <Input placeholder="Seu nome completo" className="h-14 text-lg font-opensans border-2 border-slate-200 focus:border-orange-500 rounded-xl" />
                </div>
                <div>
                  <Input type="email" placeholder="Seu e-mail" className="h-14 text-lg font-opensans border-2 border-slate-200 focus:border-orange-500 rounded-xl" />
                </div>
                <div>
                  <Input type="tel" placeholder="Telefone (opcional)" className="h-14 text-lg font-opensans border-2 border-slate-200 focus:border-orange-500 rounded-xl" />
                </div>
                <div>
                  <Textarea placeholder="Sua mensagem" rows={6} className="resize-none text-lg font-opensans border-2 border-slate-200 focus:border-orange-500 rounded-xl" />
                </div>
